...
API_ID = int(environ.get('API_ID', '12110427'))
API_HASH = environ.get('API_HASH', 'c6b9c68293136b33d209eeccf65240bd')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1470157134').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001766407039').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hkavee335:KqFxjnpVoGpaOwLn@cluster0.pogeawe.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002108349234'))
...
URL = "https://mw-filter-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mw-filter-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mw-filter-bot.onrender.com/".format(FQDN)
else:
    URL = "https://mw-filter-bot.onrender.com/".format(FQDN)
